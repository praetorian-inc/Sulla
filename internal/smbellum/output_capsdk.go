...
// capSDKEnvelope is the on-disk wire envelope the aegis-capability-sdk-parser
// expects: top-level "items" array, each item carrying a "_type" discriminator
// that matches a registered converter in
// guard/backend/pkg/tabularium/capmodel/convert_gen.go.
...
// generateCapabilitySDKOutput writes a <domain>.tabularium file whose contents
// the aegis-capability-sdk-parser ingests. Replaces the hand-rolled Tabularium
// emitter in output.go.
